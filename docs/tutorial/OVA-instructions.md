...
<img src="9-VB-login.png" width="700">
...
<img src="10-terminal-login.png" width="700">

The outputs to e.g. `pwd` and `which singularity` will be the same as shown above:

<img src="11-terminal-verify.png" width="700">
